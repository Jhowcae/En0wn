...
2. Import it into VirtualBox / VMware
3. Use NAT or Host-Only networking
...
This VM is intended **for educational purposes only**.  
Do **not** use the techniques learned here on systems you do not own or have permission to test.
